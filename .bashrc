...
__conda_setup="$('/home/naseh/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/naseh/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/naseh/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/naseh/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<

source /home/naseh/alacritty/extra/completions/alacritty.bash
